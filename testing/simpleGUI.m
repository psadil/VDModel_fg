...
% Last Modified by GUIDE v2.5 04-Jun-2015 23:46:35
...
function slider_trial_Callback(hObject, eventdata, handles)
% hObject    handle to slider_trial (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function slider_trial_CreateFcn(hObject, eventdata, handles)
% hObject    handle to slider_trial (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
