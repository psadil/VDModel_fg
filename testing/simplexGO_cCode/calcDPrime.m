...
saveFolder = [ROOT,'/graphsAndSession/', folderName];

% load sample data file to get size of parameters
fileName = [saveFolder, '/Session', '1', '_Rat', num2str(1)];
load(fileName)
...
FARate_first_adj_all = zeros(numRats,4);
FARate_first_adj_some = zeros(numRats,4);
hitRate_first_adj_all = zeros(numRats,4);
hitRate_first_adj_some = zeros(numRats,4);

FARate_second_adj_all = zeros(numRats,4);
FARate_second_adj_some = zeros(numRats,4);
hitRate_second_adj_all = zeros(numRats,4);
hitRate_second_adj_some = zeros(numRats,4);
