function finalParms = initializeSimplex_VD(nRats,nIterations)
...
consts.nRats = nRats;
consts.nIterations = nIterations;

% name of folder containing stimuli to use
consts.exptName = 'september11_2015';
...
[finalParms, ~] = wrapper4fminbnd(startParms, data);
