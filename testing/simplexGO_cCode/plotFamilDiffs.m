...
for rat = firstRat:lastRat
    for session = 1:4
        ...
        acc_match_second(rat,session) = sum(answer(rat,session,find(tType(rat,session,(36:72))==2))==0)/(sum(tType(rat,session,37:72)==2));
        acc_misMatch_first(rat,session) = sum(answer(rat,session,find(tType(rat,session,(1:36))==1))==1)/(sum(tType(rat,session,1:36)==1));
        acc_misMatch_second(rat,session) = sum(answer(rat,session,find(tType(rat,session,(36:72))==1))==1)/(sum(tType(rat,session,37:72)==1));
...
familDiffs_misMatch_caudal_std = zeros(4,72);
familDiffs_match_caudal_std = zeros(4,72);
familDiffs_misMatch_PRC_std = zeros(4,72);
familDiffs_match_PRC_std = zeros(4,72);
...
for session = 1:4
    for trial = 1:72
        ...
        familDiffs_misMatch_caudal_std_toSqr(session,trial) = familDiffs_misMatch_caudal_std_temp ./ (trial_misMatch_caudal(session,trial) -1);
        familDiffs_match_caudal_std_toSqr(session,trial) = familDiffs_match_caudal_std_temp ./ (trial_match_caudal(session,trial) -1);
        familDiffs_misMatch_PRC_std_toSqr(session,trial) = familDiffs_misMatch_PRC_std_temp ./ (trial_misMatch_PRC(session,trial) -1);
        familDiffs_match_PRC_std_toSqr(session,trial) = familDiffs_match_PRC_std_temp ./ (trial_match_PRC(session,trial) -1);
    end
end

familDiffs_misMatch_caudal_std = sqrt(familDiffs_misMatch_caudal_std_toSqr);
familDiffs_match_caudal_std = sqrt(familDiffs_match_caudal_std_toSqr);
familDiffs_misMatch_PRC_std = sqrt(familDiffs_misMatch_PRC_std_toSqr);
familDiffs_match_PRC_std = sqrt(familDiffs_match_PRC_std_toSqr);
...
%--------------------------------------------------------------------------
minY_familDiffs = 0;
maxY_familDiffs = .0003;
axisBounds_familDiffs = [0,75,minY_familDiffs,maxY_familDiffs];
...
minY_dPrime = 0;
maxY_dPrime = 1.8;
axisBounds_familDiffs = [0,75,minY_dPrime,maxY_dPrime];

%
figs(3) = figure;
subplot(1,2,1)
barweb([dPrime_first_raw(2), dPrime_second_raw(2) ; dPrime_first_raw(1), dPrime_second_raw(1)], [dPrime_first_err(2), dPrime_second_err(2) ; dPrime_first_err(1), dPrime_second_err(1)], [], {'high', 'low'})
...
subplot(1,2,2)
barweb([dPrime_first_raw(4), dPrime_second_raw(4) ; dPrime_first_raw(3), dPrime_second_raw(3)], [dPrime_first_err(4), dPrime_second_err(4) ; dPrime_first_err(3), dPrime_second_err(3)], [], {'high', 'low'})
xlabel('stim ambiguity');
ylabel('d''');
legend('first Half', 'Second Half')
...
minY_abslFamil = 0;
maxY_abslFamil = .004;
axisBounds_abslFamil = [0,75,minY_abslFamil,maxY_abslFamil];
...
minY_fixations = 0;
maxY_fixations = 60;
axisBounds_fixations = [0,75,minY_fixations,maxY_fixations];
...
axisBounds_abslFamil_newPrev = [0,75,minY_abslFamil_newPrev,maxY_abslFamil_newPrev];
...
axisBounds_peak_tType_caudal = [0,75,minY_peak_tType_caudal,maxY_peak_tType_caudal];

minY_peak_tType_PRC = 0;
maxY_peak_tType_PRC = p.sizeOfPeak;
axisBounds_peak_tType_PRC = [0,75,minY_peak_tType_PRC,maxY_peak_tType_PRC];
...
figs(21) = figure;
subplot(1,2,1)
barweb([dPrime_first_adj_all(2), dPrime_second_adj_all(2) ; dPrime_first_adj_all(1), dPrime_second_adj_all(1)], [dPrime_first_adj_all_err(2), dPrime_second_adj_all_err(2) ; dPrime_first_adj_all_err(1), dPrime_second_adj_all_err(1)], [], {'high', 'low'})
xlabel('stim ambiguity');
ylabel('d''');
legend('first Half', 'Second Half')
title({'dPrime of Lesion'})
...
subplot(1,2,2)
barweb([dPrime_first_adj_all(4), dPrime_second_adj_all(4) ; dPrime_first_adj_all(3), dPrime_second_adj_all(3)], [dPrime_first_adj_all_err(4), dPrime_second_adj_all_err(4) ; dPrime_first_adj_all_err(3), dPrime_second_adj_all_err(3)], [], {'high', 'low'})
xlabel('stim ambiguity');
ylabel('d''');
legend('first Half', 'Second Half')
title({'dPrime of Control'})
...
figs(22) = figure;
subplot(1,2,1)
barweb([dPrime_first_adj_some(2), dPrime_second_adj_some(2) ; dPrime_first_adj_some(1), dPrime_second_adj_some(1)], [dPrime_first_adj_some_err(2), dPrime_second_adj_some_err(2) ; dPrime_first_adj_some_err(1), dPrime_second_adj_some_err(1)], [], {'high', 'low'})
xlabel('stim ambiguity');
ylabel('d''');
legend('first Half', 'Second Half')
title({'dPrime of Lesion'})
...
subplot(1,2,2)
barweb([dPrime_first_adj_some(4), dPrime_second_adj_some(4) ; dPrime_first_adj_some(3), dPrime_second_adj_some(3)], [dPrime_first_adj_some_err(4), dPrime_second_adj_some_err(4) ; dPrime_first_adj_some_err(3), dPrime_second_adj_some_err(3)], [], {'high', 'low'})
xlabel('stim ambiguity');
ylabel('d''');
legend('first Half', 'Second Half')
title({'dPrime of Control'})
