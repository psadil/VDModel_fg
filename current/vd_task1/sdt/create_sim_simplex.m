...
for e = etaToTry
    for ks = kToTry
        for comp = compsToTry
            ...
            consts.nameOfFolder = ['g/eta', num2str(eta), '_g', num2str(g), ...
            ...
            for rat = firstRat:lastRat
                ...
                p.maxFixations = [1, 1]; % should it be based on empirical data? total # saccades on match trials = 20
                ...
                p.fixn_ratio_lowHigh = [.001, .001]; % now describes ratio of within/total
                p.outsideRatio = [.2,.1];
                p.sizeOfPeak = 5;
