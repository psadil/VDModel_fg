...
while notUnique
    ...
    for item = 1:p.nMismatch-1
        ...
        for trial = item+1:p.nMismatch
            ...
            if LA_misMatch(item,:,:) == (LA_misMatch(trial,:,:))
                notUnique = 1;
                breakOut = 1;
                break;
                
            elseif LA_match(item,:,:) == (LA_match(trial,:,:))
                notUnique=1;
                breakOut = 1;
                break;
                
            elseif LA_misMatch(item,:,:) == (LA_match(trial,:,:))
                notUnique=1;
                breakOut = 1;
                break;
                
            elseif LA_match(item,:,:) == (LA_misMatch(trial,:,:))
                notUnique=1;
                breakOut = 1;
                break;
            end
...
%     
    ...
    for item = 1:p.nMismatch-1
        ...
        for trial = item+1:p.nMismatch
            ...
            if HA_misMatch(item,:,:) == (HA_misMatch(trial,:,:))
                notUnique = 1;
                breakOut = 1;
                break;
                
            elseif HA_match(item,:,:) == (HA_match(trial,:,:))
                notUnique=1;
                breakOut = 1;
                break;
                
            elseif HA_misMatch(item,:,:) == (HA_match(trial,:,:))
                notUnique=1;
                breakOut = 1;
                break;
                
            elseif HA_match(item,:,:) == (HA_misMatch(trial,:,:))
                notUnique=1;
                breakOut = 1;
                break;
            end
