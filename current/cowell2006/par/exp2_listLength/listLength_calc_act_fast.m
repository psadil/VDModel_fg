function [f_out, act_out] = listLength_calc_act_fast(win_row, win_col, dist_mat, layer, p)

% This function is called from listLength_present_stimulus.m. Calculates the activation on the grid and the f matrix determining
