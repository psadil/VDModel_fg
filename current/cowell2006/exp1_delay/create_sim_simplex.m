...
consts.exptName = '8jan2016';
consts.nameOfFolder = ['eta', num2str(eta), '_g', num2str(g), ...
    '_K', num2str(k), '_A', num2str(A) ,'_B', num2str(B), '_20enc20_', num2str(train), ...
    'trnRAND_','5pk_20Fix_', num2str(noise),'nois_', num2str(startCrit), 'stCrt_',num2str(leng), 'leng_', ...
    'noABS_wtSwp'];
% wtSwp -> grab initial weights after updating
